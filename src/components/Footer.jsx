...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-dark-400 bg-dark-900">

      <div
        className="max-w-6xl mx-auto px-6 md:px-16 lg:px-28 py-10
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
          ...
          <span className="hidden md:block text-dark-400">
            |
          </span>
        ...
        {/* Center */}
        <p className="font-mono text-xs text-dark-200 text-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="text-dark-200 hover:text-mint-400 transition-colors"
            aria-label="GitHub"
          >
